...
const ContactEntry = ({ icon, text, link }) => {
  const textElementToRender = link ? (
    <Link src={link}>
      <Text contrast style={entryStyles.linkText}>
        {text}
      </Text>
    </Link>
  ) : (
    <Text contrast style={entryStyles.text}>
      {text}
    </Text>
  );
  ...
  return (
    <View style={entryStyles.container}>
      <View style={entryStyles.icon}>{icon}</View>
      {textElementToRender}
    </View>
  );
};
  ...
  return (
    <View style={styles.container}>
      ...
      <ContactEntry
        ...
        text={"botoc.valentin@gmail.com"}
        link={"mailto:botoc.valentin@gmail.com"}
      />
      ...
      <ContactEntry
        ...
        text={"in/valentin-botoc"}
        link={"https://www.linkedin.com/in/valentin-botoc"}
      />
